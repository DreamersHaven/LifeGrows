...
public class UserController extends BasicController {
	...
	@ApiOperation(value = "查询所有用户信息，按注册日期倒排序", notes = "查询所有用户信息")
	@PostMapping("/queryAllUsers")
	public IMoocJSONResult queryAllUsers(@RequestParam("currentPage") Integer currentPage,
            @RequestParam("pageSize") Integer pageSize,
            DesignUserDO user) throws Exception {

		IPage<DesignUserDO> iPage = userService.selectPageExt(user, currentPage, pageSize);
		return IMoocJSONResult.ok(iPage.getRecords());
	}
